Mongoid Magic Counter Cache [![Build Status](https://secure.travis-ci.org/mcelona/mongoid-magic-counter-cache.png?branch=master)](http://travis-ci.org/mcelona/mongoid-magic-counter-cache)
=======
